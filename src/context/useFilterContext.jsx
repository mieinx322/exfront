...
export const FilterProvider = ({
  ...
  const updateSearch = search => updateState({
    search
  });
  const updateMinPrice = minPrice => updateState({
    minPrice
  });
  const updateMaxPrice = maxPrice => updateState({
    maxPrice
  });
  const updateRating = rating => updateState({
    rating
  });
  useEffect(() => {
    let query = '';
  ...
  return <FilterContext.Provider value={useMemo(() => ({
    ...state,
    updateCategory,
    updateRestaurant,
    updateSearch,
