      ...
      backgroundImage: `url(${offerBgOtherImg})`
        ...
        <div className="p-12">
          <div className="mb-6 flex justify-center">
            <img src={filterOfferDishOtherImg} alt="dish" />
          </div>
          ...
          <button className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-white transition-all hover:bg-primary-500" type="button">
