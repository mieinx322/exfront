          ...
          <div className="flex items-center">
            <ol aria-label="Breadcrumb" className="flex min-w-0 items-center gap-2 whitespace-nowrap">
              <li className="text-sm">
                <Link className="flex items-center gap-2 align-middle leading-none text-default-800 transition-all hover:text-primary-500" to="/home">
                  <LuHome size={16} />
                  Home
                  <LuChevronRight size={16} />
                </Link>
              </li>
              {subtitle && <li className="text-sm">
                  <Link className="flex items-center gap-2 align-middle leading-none text-default-800 transition-all hover:text-primary-500" to="">
                    {subtitle}
                    <LuChevronRight size={16} />
                  </Link>
                </li>}
