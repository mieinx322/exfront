        ...
        <div className="grid grid-cols-1 gap-x-6 gap-y-10 divide-y divide-default-200 xl:grid-cols-3 xl:divide-x xl:divide-y-0">
            ...
            <div className="px-6">
              <div className="space-y-2">
                <div className="relative flex h-2 w-full overflow-hidden rounded-full bg-default-200">
                  <div className="flex h-full w-[35%] items-center justify-center rounded-full bg-primary text-white" role="progressbar" aria-valuenow={35} aria-valuemin={0} aria-valuemax={100} />
                </div>
          ...
          <div className="xl:col-span-1">
            <div className="pt-10 text-start xl:ps-10 xl:pt-0 xl:text-end">
              ...
              <div className="mb-4">
                <input type="checkbox" id="hs-basic-usage" className="relative h-7 w-[3.25rem] cursor-pointer appearance-none rounded-full border-2 border-transparent bg-default-200 transition-colors duration-200 ease-in-out before:inline-block before:h-6 before:w-6 before:translate-x-0 before:transform before:rounded-full before:bg-white before:shadow before:transition before:duration-200 before:ease-in-out checked:!bg-green-500 checked:bg-none checked:before:translate-x-full focus:ring-0 focus:ring-transparent" onChange={() => toggleActive()} defaultChecked />
