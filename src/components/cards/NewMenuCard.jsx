...
const NewMenuCard = ({
  ...
  return <div className="rounded-lg bg-default-500/5 p-4">
      <div className="mb-4 flex items-center justify-between gap-6">
        <div className="h-6 w-6">
          <BiFoodTag color={type == 'non-veg' ? 'red' : type == 'veg' ? 'green' : 'orange'} />
        </div>
        <Link to="" className="group inline-flex items-center justify-center gap-2 rounded-full border border-primary px-3 py-1.5 text-sm font-medium text-primary transition-all duration-300 hover:bg-primary hover:text-white">
