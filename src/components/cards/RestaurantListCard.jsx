...
const RestaurantListCard = ({
  ...
  return <div className="relative rounded-lg border border-default-200 p-6">
      ...
      <div className="text-center">
        <Link to={`/admin/restaurants/${id}`} className="inline-flex rounded-lg bg-primary px-8 py-2.5 font-medium text-white transition-all hover:bg-primary-500">
          View Details
        </Link>
      </div>
    </div>;
