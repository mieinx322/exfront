...
const BestSellingProductCard = ({
  ...
  return <Link to="" className="overflow-hidden rounded-lg border border-default-200 p-4 transition-all duration-300 hover:border-primary">
      <div className="relative divide-y divide-default-200 overflow-hidden rounded-lg">
        <div className="mx-auto mb-4">
          <img src={images[0]} width={204} height={159} className="h-full w-full" alt={name} />
        </div>
        <div className="pt-2">
