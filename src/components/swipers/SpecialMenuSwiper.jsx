...
const SpecialMenuSwiper = ({
  dishes
}) => {
  return <Swiper className="menu-swiper h-full w-full" modules={[Thumbs, Navigation]} spaceBetween={12} pagination={{
    ...
    1300: {
      ...
      {dishes.map(dish => <SwiperSlide key={dish.id}>
          <div className="relative cursor-pointer overflow-hidden rounded-lg">
            <img src={dish.images[0]} className="h-full w-full" alt="pizza" width={336.7} height={449.7} />
            <div className="absolute inset-0 bg-black/20">
              <div className="inline-flex h-full w-full items-end">
                <div className="p-6">
                  ...
                  <Link to="/dishes" className="inline-flex items-center border-b border-dashed border-white text-white">
