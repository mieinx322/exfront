...
const AuthFormLayout = ({
  ...
  return <div className="flex items-center justify-center lg:max-w-lg">
      <div className="flex h-full flex-col">
        <div className="shrink">
          <div>
            <Link to="/" className="flex items-center">
              <img width={156} height={48} src={logoDarkImg} alt="logo" className="flex h-12 dark:hidden" />
              <img width={156} height={48} src={logoLightImg} alt="logo" className="hidden h-12 dark:flex" />
            </Link>
          </div>
          <div className="py-10">
          ...
          {hasThirdPartyAuth && <div className="my-6 flex items-center justify-center gap-4">
