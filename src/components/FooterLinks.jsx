...
const FooterLinks = () => {
  return <div className="border-t border-default-200">
        ...
        <div className="grid items-center gap-6 py-6 lg:grid-cols-3 lg:py-10">
          <div className="lg:col-span-2">
            <div className="mb-6 grid grid-cols-2 gap-6 md:grid-cols-4">
              ...
              return <div className="flex flex-col gap-3" key={title + idx}>
                    <h5 className="mb-3 font-semibold text-default-950">{title}</h5>
                    {FOOTER_LINKS[title].map((item, idx) => <div className="text-default-600" key={item.name + idx}>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  const Icon = icon;
                  return <Link key={idx} to="" className="cursor-pointer">
