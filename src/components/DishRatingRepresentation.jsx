      ...
      <div className="grid items-center gap-5 lg:grid-cols-4">
        ...
        <div className="md:col-span-3 xl:col-span-2">
          <div className="mb-3 grid items-center gap-2 md:grid-cols-12">
            ...
            <div className="md:col-span-7">
              <div className="flex h-1 w-full overflow-hidden rounded-full bg-default-200">
                <div className="flex w-4/6 flex-col justify-center overflow-hidden rounded bg-primary" role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100} />
              </div>
            </div>
          ...
          <div className="mb-3 grid items-center gap-2 md:grid-cols-12">
            ...
            <div className="md:col-span-7">
              <div className="flex h-1 w-full overflow-hidden rounded-full bg-default-200">
                <div className="flex w-1/4 flex-col justify-center overflow-hidden rounded bg-primary" role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100} />
              </div>
            </div>
            <div className="md:col-span-2">
          ...
          <div className="mb-3 grid items-center gap-2 md:grid-cols-12">
            ...
            <div className="md:col-span-7">
              <div className="flex h-1 w-full overflow-hidden rounded-full bg-default-200">
                <div className="flex w-2/12 flex-col justify-center overflow-hidden rounded bg-primary" role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100} />
              </div>
            </div>
            <div className="md:col-span-2">
          ...
          <div className="mb-3 grid items-center gap-2 md:grid-cols-12">
            ...
            <div className="md:col-span-7">
              <div className="flex h-1 w-full overflow-hidden rounded-full bg-default-200">
                <div className="flex w-1/12 flex-col justify-center overflow-hidden rounded bg-primary" role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100} />
              </div>
            </div>
            <div className="md:col-span-2">
          ...
          <div className="grid items-center gap-2 md:grid-cols-12">
            ...
            <div className="md:col-span-7">
              <div className="flex h-1 w-full overflow-hidden rounded-full bg-default-200">
                <div className="flex w-[4%] flex-col justify-center overflow-hidden rounded bg-primary" role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100} />
              </div>
            </div>
            <div className="md:col-span-2">
