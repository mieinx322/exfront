...
const Footer = ({
  ...
  return <footer className={cn('absolute w-full border-t border-default-200 p-6 hide-in-print', hideLinks ? 'lg:ps-64' : 'lg:ps-8')}>
      <div className={cn('container', hideLinks && 'ms-2')}>
        <div className="grid items-center gap-6 lg:grid-cols-2">
          ...
          {!hideLinks && <div className="flex justify-end gap-6">
