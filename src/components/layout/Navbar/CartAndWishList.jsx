...
const CartAndWishList = () => {
  ...
  return <>
      <li className="menu-item flex">
        <Link to="/cart" className="relative flex text-base text-default-600 transition-all hover:text-primary">
      ...
      <li className="menu-item flex">
        <Link to="/wishlist" className="relative flex text-base text-default-600 transition-all hover:text-primary">
