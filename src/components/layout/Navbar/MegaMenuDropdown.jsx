                ...
                <div className="col-span-2 text-sm">
                  <div className="h-full w-full bg-default-100 px-6 py-10">
                    <nav aria-label="Tabs" className="flex flex-col space-y-3.5" data-hs-tabs-vertical="true" role="tablist">
                      <button className="active inline-flex items-center !bg-transparent text-base font-medium text-default-600 transition-all hover:text-primary hs-tab-active:text-primary" data-hs-tab="#wraps" role="tab" type="button">
                        Wraps <LuChevronRight size={20} className="ms-auto" />
                      </button>
                      <button className="inline-flex items-center !bg-transparent text-base font-medium text-default-600 transition-all hover:text-primary hs-tab-active:text-primary" data-hs-tab="#noodles" role="tab" type="button">
                        Noodles <LuChevronRight size={20} className="ms-auto" />
                      </button>
                      <button className="inline-flex items-center !bg-transparent text-base font-medium text-default-600 transition-all hover:text-primary hs-tab-active:text-primary" data-hs-tab="#mexican" role="tab" type="button">
                        Mexican cuisine <LuChevronRight size={20} className="ms-auto" />
                      </button>
                      <button className="inline-flex items-center !bg-transparent text-base font-medium text-default-600 transition-all hover:text-primary hs-tab-active:text-primary" data-hs-tab="#tacos" role="tab" type="button">
                        Tacos <LuChevronRight size={20} className="ms-auto" />
                      </button>
                      <button className="inline-flex items-center !bg-transparent text-base font-medium text-default-600 transition-all hover:text-primary hs-tab-active:text-primary" data-hs-tab="#smart-meals" role="tab" type="button">
                        Smart Meals <LuChevronRight size={20} className="ms-auto" />
                      </button>
                      <button className="inline-flex items-center !bg-transparent text-base font-medium text-default-600 transition-all hover:text-primary hs-tab-active:text-primary" data-hs-tab="#burger" role="tab" type="button">
                        Burger <LuChevronRight size={20} className="ms-auto" />
                      </button>
                      <button className="inline-flex items-center !bg-transparent text-base font-medium text-default-600 transition-all hover:text-primary hs-tab-active:text-primary" data-hs-tab="#beverages-desserts" role="tab" type="button">
                      ...
                      <div className="grid grid-cols-4 divide-x divide-default-200">
                        <div className="ps-6">
                          ...
                          <ul className="mt-4 grid space-y-3">
                            <li>
                              <Link to="" className="text-sm font-medium text-default-600 transition-all hover:text-primary">
                                Black Bean Wrap
                              </Link>
                            </li>
                            <li>
