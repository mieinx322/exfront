...
const MenuAdmin = () => {
  return <div id="application-sidebar" className="hs-overlay fixed inset-y-0 start-0 z-[90] hidden w-64 -translate-x-full transform overflow-y-auto border-e border-default-200 bg-white transition-all duration-300 hs-overlay-open:translate-x-0 dark:bg-default-50 lg:bottom-0 lg:right-auto lg:block lg:translate-x-0 hide-in-print">
      ...
      <ul className="admin-menu flex flex-col gap-2 px-4 pt-10">
        ...
        <li className="menu-item">
          <Link className="flex items-center gap-x-3.5 rounded-md px-4 py-3 text-sm text-red-500 hover:bg-red-400/10 hover:text-red-600" to="/auth/logout">
            <LuLogOut size={20} />
            Logout
          </Link>
        </li>
