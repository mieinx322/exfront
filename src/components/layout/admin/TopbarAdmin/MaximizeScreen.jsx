...
const MaximizeScreen = () => {
  ...
  return <button onClick={toggleFullScreen} className="inline-flex h-10 w-10 flex-shrink-0 items-center justify-center gap-2 rounded-full bg-default-100 align-middle text-xs font-medium text-default-700 transition-all hover:text-primary">
