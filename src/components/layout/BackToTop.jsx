...
const BackToTop = () => {
  ...
  return <div className="fixed bottom-18 end-5 z-10 flex flex-col items-center rounded-full bg-primary/25 lg:bottom-5">
      <button className={cn('z-10 flex w-8 items-center justify-center transition-all duration-500', scrollY >= 72 ? 'h-8' : 'h-0 translate-y-5 opacity-0')} onClick={() => window.scrollTo({
      top: 0,
      behavior: 'smooth'
    })}>
