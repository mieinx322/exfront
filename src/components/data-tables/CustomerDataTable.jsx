            ...
            <table className="min-w-full divide-y divide-default-200">
              <thead className="bg-default-100">
                <tr>
                  ...
                  {columns.map(column => <th key={column.key} scope="col" className="whitespace-nowrap px-6 py-4 text-start text-sm font-medium text-default-500">
                      {column.name}
                    </th>)}
                </tr>
              </thead>
              <tbody className="divide-y divide-default-200">
                ...
                return <tr key={idx}>
                    ...
                    if (column.key == 'joining_date') {
                      return <td key={tableData + idx} className="whitespace-nowrap px-6 py-4 text-base text-default-800">
                              {tableData} |&nbsp;
                      ...
                      return <td key={tableData + idx} className="whitespace-nowrap px-6 py-4">
