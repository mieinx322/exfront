          ...
          <div className="p-8">
            <form className="mb-6 space-y-2" onSubmit={handleSubmit(() => {})}>
              ...
              <div className="flex rounded-md shadow-sm">
                <TextFormInput name="email" className="form-input  bg-white" control={control} placeholder="Email address" endButtonIcon={<LuArrowRight size={20} />} startInnerIcon={<LuMail size={20} />} fullWidth />
              </div>
            </form>
