      ...
      <div className="rounded-lg border border-default-200">
        <div className="p-6 pb-0">
          <div className="text-center mt-2">
            ...
            <button type="button" className="py-2 px-4 inline-flex font-semibold tracking-wide align-middle duration-500 text-sm text-center rounded-lg bg-primary/90 text-white hover:bg-primary me-1">
              Follow
            </button>
            <button type="button" className="py-2 px-4 inline-flex font-semibold tracking-wide align-middle duration-500 text-sm text-center rounded-lg bg-white border border-gray-200 hover:bg-light hover:border-transparent dark:bg-transparent dark:border-gray-600 dark:hover:bg-secondary/20">
              Message
            </button>
            <div className="mt-7 pt-5 border-t text-start dark:border-gray-600">
              <p className="text-gray-500 mb-2 dark:text-gray-400">
                Hi I'm Yum. I am user experience and user type designer. I
      ...
      <div className="rounded-lg border border-default-200 relative">
        ...
        <div className="p-6 text-center pt-0 -mt-12">
          <div className="profile-info pb-3">
            ...
            <button type="button" className="rounded-lg py-2 px-4 font-semibold tracking-wide justify-center duration-500 text-sm text-center rounded-lg-sm bg-primary/90 text-white hover:bg-primary me-1">
              Follow
            </button>
            <button type="button" className="align-middle justify-center duration-500 text-sm text-center rounded-lg py-2 px-4 font-semibold tracking-wide  bg-white border border-gray-200 hover:bg-light hover:border-transparent dark:bg-transparent dark:border-gray-600 dark:hover:bg-secondary/20">
              Message
            </button>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-5 mt-10">
            <div className="w-full">
              <button type="button" className="justify-center rounded-lg py-2 px-4 inline-flex font-semibold tracking-wide align-middle duration-500 text-sm text-center rounded-lg-sm w-full bg-primary/90 text-white hover:bg-primary me-1">
                Follow
              </button>
            </div>
            <div className="w-full">
              <button type="button" className="justify-center rounded-lg w-full py-2 px-4 inline-flex font-semibold tracking-wide align-middle duration-500 text-sm text-center rounded-lg-sm bg-white border border-gray-200 hover:bg-light hover:border-transparent dark:bg-transparent dark:border-gray-600 dark:hover:bg-secondary/20">
                Message
              </button>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 items-center">
            ...
            <div className="md:col-span-2">
              <div className="p-6 py-0">
                <h5 className="text-lg mt-2 mb-0 dark:text-gray-300">
                  Yum N
                </h5>
                ...
                <div className="flex items-center gap-5 mt-5">
                  ...
                  <div className="w-full">
                    <button type="button" className="justify-center rounded-lg py-2 px-4 inline-flex font-semibold tracking-wide align-middle duration-500 text-sm text-center rounded-lg-sm bg-white border border-gray-200 hover:bg-light hover:border-transparent dark:bg-transparent dark:border-gray-600 dark:hover:bg-secondary/20">
                      Message
                    </button>
                  </div>
                </div>
