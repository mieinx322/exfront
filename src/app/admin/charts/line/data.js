...
export const dataLabelsLineChart = {
  chart: {
    height: 380,
    type: 'line',
    zoom: {
...
// Zoomable Timeseries
export const zoomableTimeseriesChart = {
  chart: {
    type: 'area',
    stacked: false,
    height: 380,
...
export const annotationsLineChart = {
  annotations: {
    yaxis: [{
      y: 8200,
      borderColor: '#47ad77',
...
export const syncingLineChart2 = {
  chart: {
    type: 'line',
    height: 160,
    id: 'fb',
