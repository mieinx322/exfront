...
import { basicTable, contextualTable, nestingTable, responsiveTable } from '../data';
const BasicTables = () => {
      ...
      <div className="page-content space-y-6 p-6">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
          <div className="border border-default-200 rounded-lg">
            <div className="p-6">
              <h3 className="font-medium text-base text-default-600 mb-4">Basic example</h3>
                ...
                <div className="min-w-full inline-block align-middle">
                  <div className="overflow-hidden">
                    <table className="min-w-full divide-y divide-default-200">
                      <thead>
                        <tr>
                          <th scope="col" className="px-4 py-4 text-start text-sm font-semibold text-default-600">
                            #
                          </th>
                          <th scope="col" className="px-4 py-4 text-start text-sm font-semibold text-default-600">
                            First
          ...
          <div className="border border-default-200 rounded-lg">
            <div className="p-6">
              <h3 className="font-medium text-base text-default-600 mb-4">Table Dark</h3>
              <p className="text-default-600 mb-4">
                    ...
                    <table className="min-w-full divide-y divide-default-200">
                      <thead>
                        <tr className="bg-default-100">
                          <th scope="col" className="px-4 py-4 text-start text-sm font-semibold text-default-800">
                            #
                          </th>
                          <th scope="col" className="px-4 py-4 text-start text-sm font-semibold text-default-800">
                            First
                    ...
                    <table className="min-w-full divide-y divide-default-200">
                      <thead>
                        <tr className="bg-slate-900">
                          <th scope="col" className="px-4 py-4 text-start text-sm font-semibold text-slate-100">
                            #
                          </th>
                          <th scope="col" className="px-4 py-4 text-start text-sm font-semibold text-slate-100">
                            First
          ...
          <div className="border border-default-200 rounded-lg">
            <div className="p-6">
              ...
              <p className="text-default-600 mb-4">
                Add <code className="text-danger">border</code> for borders on all
              ...
              <div className="relative overflow-auto">
                <table className="border-collapse min-w-full border border-default-200 bg-white dark:bg-transparent text-sm shadow-sm">
                  ...
                  <tbody>
                    {(basicTable || []).map((value, idx) => {
                    return <tr key={idx}>
                          <th scope="row" className={`flex items-center gap-2 px-4 py-4 text-default-900 whitespace-nowrap dark:text-default-400 ${value.id !== 1 ? 'border-t border-default-200' : ''}`}>
                            {value.id}
                          </th>
                          {value.id === 3 ? <td colSpan={2} className="border border-default-200 px-4 py-4 text-slate-500 dark:text-default-400">
          ...
          <div className="border border-default-200 rounded-lg">
            <div className="p-6">
              <h3 className="font-medium text-base text-default-600 mb-4">Border Color</h3>
              <p className="text-default-600 mb-4">
              ...
              <div className="relative overflow-auto">
                <table className="border-collapse min-w-full border border-primary dark:border-primary bg-white dark:bg-transparent text-sm shadow-sm">
                  ...
                  <tbody>
                    {(basicTable || []).map((value, idx) => {
                    return <tr key={idx}>
                          <th scope="row" className={`flex items-center gap-2 px-4 py-4 text-default-900 whitespace-nowrap dark:text-default-400 ${value.id !== 1 ? 'border-t border-primary dark:border-primary' : ''}`}>
                            {value.id}
                          </th>
                          {value.id === 3 ? <td colSpan={2} className="border border-primary dark:border-primary px-4 py-4 text-slate-500 dark:text-default-400">
                              {value.firstName} {value.lastName}
                            </td> : <>
          ...
          <div className="border border-default-200 rounded-lg">
            <div className="p-6">
              <h3 className="font-medium text-base text-default-600 mb-4">Small table</h3>
              <p className="text-default-600 mb-4">
                ...
                <div className="min-w-full inline-block align-middle">
                  <div className="overflow-hidden">
                    <table className="min-w-full divide-y divide-default-200">
                      <thead>
                        <tr>
                          <th scope="col" className="px-4 py-2 text-start text-sm font-semibold text-default-600">
                            #
                          </th>
                          <th scope="col" className="px-4 py-2 text-start text-sm font-semibold text-default-600">
                            First
                      ...
                      <tbody className="divide-y divide-default-200">
                        ...
                        return <tr key={idx}>
                              ...
                              {value.id === 3 ? <td colSpan={2} className="px-4 py-2 whitespace-nowrap text-sm text-default-600">
                                  {value.firstName} {value.lastName}
                                </td> : <>
                ...
                <div className="min-w-full inline-block align-middle">
                  <div className="overflow-hidden">
                    <table className="min-w-full divide-y divide-default-200">
                      ...
                      <tbody className="divide-y divide-default-200">
                        {(basicTable || []).map((value, idx) => {
                        return <tr key={idx} className="hover:bg-default-100 dark:hover:bg-transparent">
                              <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-default-600">
                                {value.id}
                              </td>
                              <td className="px-4 py-4 whitespace-nowrap text-sm text-default-600">
          ...
          <div className="border border-default-200 rounded-lg">
            <div className="p-6">
              <h3 className="font-medium text-base text-default-600 mb-4">Active Tables</h3>
              <p className="text-default-600 mb-4">
                Add
                <code className="text-danger">
                  hover:{'{'}color{'}'}-*
                ...
                <div className="min-w-full inline-block align-middle">
                  <div className="overflow-hidden">
                    <table className="min-w-full divide-y divide-default-200">
                      ...
                      <tbody className="divide-y divide-default-200">
                        {(basicTable || []).map((value, idx) => {
                        return <tr key={idx} className={`${value.id === 1 ? 'bg-default-100 dark:bg-transparent' : 'hover:bg-default-100 dark:hover:bg-transparent'}`}>
                              <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-default-600">
                                {value.id}
                              </td>
                              {value.id === 3 ? <td colSpan={2} className="px-4 py-4 whitespace-nowrap text-sm text-default-600 bg-default-100 dark:bg-transparent">
                                  {value.firstName} {value.lastName}
                                </td> : <>
                                  <td className="px-4 py-4 whitespace-nowrap text-sm text-default-600">
                                    {value.firstName}
          ...
          <div className="border border-default-200 rounded-lg">
            <div className="p-6">
              <h3 className="font-medium text-base text-default-600 mb-4">Striped rows</h3>
              <p className="text-default-600 mb-4">
                ...
                <div className="min-w-full inline-block align-middle">
                  <div className="overflow-hidden">
                    <table className="min-w-full divide-y divide-default-200">
                      ...
                      <tbody className="divide-y divide-default-200">
                        {(basicTable || []).map((value, idx) => {
                        return <tr key={idx} className={`${value.id !== 2 ? 'bg-default-100 dark:bg-transparent' : ''}`}>
                              <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-default-600">
                                {value.id}
                              </td>
                              <td className="px-4 py-4 whitespace-nowrap text-sm text-default-600">
          ...
          <div className="border border-default-200 rounded-lg">
            <div className="p-6">
              <h3 className="font-medium text-base text-default-600 mb-4">Captions</h3>
              <p className="text-default-600 mb-4">
                A functions like a heading for a table. It helps users with screen
                readers to find a table and understand what it’s about and decide
              ...
              <div className="overflow-auto">
                <div className="min-w-full inline-block align-middle">
                  <div className="overflow-hidden">
                    ...
                    <p className="ps-2 text-default-600">
                      List of users
                    </p>
                  </div>
                </div>
                  ...
                  <div className="overflow-hidden">
                    <table className="min-w-full divide-y divide-default-200">
                      ...
                      <tbody className="divide-y divide-default-200">
                        ...
                        return <tr key={idx} className={`${value.id === 1 ? `bg-${value.variant}-100 dark:bg-transparent` : `bg-${value.variant}/40`}`}>
                              <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-default-600">
                                {value.id}
                              </td>
                              <td className="px-4 py-4 whitespace-nowrap text-sm text-default-600">
                ...
                <div className="min-w-full inline-block align-middle">
                  <div className="overflow-hidden">
                    <table className="min-w-full">
                      ...
                      <tbody>
                        {(basicTable || []).map((value, idx) => {
                        return <tr key={idx} className={`${value.id !== 2 ? 'bg-default-50 border-y border-default-200' : ''}`}>
                              {value.id === 2 ? <td colSpan={4} className="p-4">
                                  <table className="min-w-full divide-y divide-default-200">
                                    <thead>
                                      <tr>
                                        <th scope="col" className="px-2 py-4 text-start text-sm font-semibold text-default-600">
                                          header
                                        </th>
                                        <th scope="col" className="px-2 py-4 text-start text-sm font-semibold text-default-600">
                                          header
                                  ...
                                  return <tr key={idx} className="border-b border-default-200 dark:border-default-600">
                  ...
                  <div className="min-w-full inline-block align-middle">
                    <div className="overflow-hidden">
                      <table className="min-w-full divide-y divide-default-200">
                        <thead>
                          <tr>
                            <th scope="col" className="px-4 py-4 text-start text-sm font-semibold text-default-700 dark:text-default-400">
                              #
                            </th>
                            <th scope="col" className="px-4 py-4 text-start text-sm font-semibold text-default-700 dark:text-default-400">
                              Table heading
                        ...
                        <tbody className="divide-y divide-default-200">
                          ...
                          return <tr key={idx}>
                                <th scope="col" className="px-4 py-4 text-start text-sm font-medium text-default-600">
                                  {value}
                                </th>
                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-default-600">
                                  Table cell
