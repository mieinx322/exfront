      ...
      <div className="page-content space-y-6 p-6">
        ...
        <div className="border border-default-200 rounded-lg">
          ...
          <div className="p-6">
            ...
            <Grid data={basicDataTable} columns={['id', 'Name', 'Email', 'Position', 'Company', 'Country', 'Action']} pagination={{
              enabled: true,
              limit: 5
        ...
        <div className="border border-default-200 rounded-lg">
          ...
          <div className="p-6">
            ...
            <Grid data={paginationDataTable} columns={['id', 'Name', 'Date', 'Total', 'Status', 'Action']} pagination={{
              enabled: true,
              limit: 5
            }} />
          </div>
        ...
        <div className="border border-default-200 rounded-lg">
          ...
          <div className="p-6">
            ...
            <Grid data={basicDataTable} columns={['Name', 'Email', 'Position', 'Company', 'Country']} pagination={{
              enabled: true,
              limit: 5
            }} search={true} />
          </div>
        ...
        <div className="border border-default-200 rounded-lg">
          ...
          <div className="p-6">
            ...
            <Grid data={basicDataTable} columns={['Name', 'Email', 'Position', 'Company', 'Country']} height="300px" fixedHeader={true} pagination={{
              enabled: true,
              limit: 10
            }} />
          </div>
        ...
        <div className="border border-default-200 rounded-lg">
          ...
          <div className="p-6">
            ...
            <Grid data={basicDataTable} columns={[{
              id: 'id',
              hidden: true
            }, 'Name', 'Email', 'Position', 'Company', {
              country: 'Country',
              hidden: true
            }]} sort={true} pagination={{
              enabled: true,
              limit: 5
            }} />
          </div>
