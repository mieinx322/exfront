              ...
              <div className="overflow-hidden rounded-lg border border-default-200">
                ...
                <div className="custom-scroll h-[40rem] overflow-y-scroll">
                  <div className="space-y-4 px-6 pb-6">
                    {dishesData.map(dish => <UpcomingNewMenuCard key={dish.id} product={dish} />)}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="p-5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-end">
                    <Link to="/admin/add-dish" className="inline-flex items-center justify-center gap-2 rounded-lg border border-primary bg-primary px-10 py-4 text-center text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-primary-500">
                      Add Menu items
                    </Link>
                  </div>
                </div>
