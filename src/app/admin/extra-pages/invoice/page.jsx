          ...
          <div className="p-6">
                  ...
                  <div className="flex sm:justify-end space-y-2">
                    <div className="grid gap-3">
                      <div className="grid grid-cols-4 gap-x-3">
                        <h6 className="col-span-2 font-semibold text-default-600">Order Date:</h6>
                        <p className="col-span-2 sm:text-end text-gray-400">Jan 17, 2023</p>
                      </div>

                      <div className="grid grid-cols-4 gap-x-3">
                        <h6 className="col-span-2 font-semibold text-default-600">Order Status:</h6>
                      ...
                      <div className="grid grid-cols-4 gap-x-3">
                        <h6 className="col-span-2 font-semibold text-default-600">Order ID:</h6>
            ...
            <div className="mb-10">
              <div className="grid sm:grid-cols-3 gap-6">
                ...
                <div className="col-span-1">
                  ...
                  <address className="not-italic">
                    Kaiya Botosh <br /> 795 Folsom Ave, Suite 600 <br /> San Francisco, CA 94107 <br /> P: (123) 456-7890{' '}
                  </address>
                </div>
                      ...
                      <table className="min-w-full">
                        <thead className="border-y border-default-200 py-3 bg-default-100">
                          <tr>
                            ...
                            <th scope="col" className="px-6 py-2 whitespace-nowrap text-right font-semibold text-default-600">
                              Total
                            </th>
                          </tr>
                        </thead>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="col-span-1">
                <div className="flex sm:justify-end space-y-2">
                  <div className="grid gap-3">
                    <div className="grid grid-cols-4 gap-x-3">
                      <h6 className="col-span-2 font-semibold text-default-600">Sub-total:</h6>
                      <p className="col-span-2 sm:text-end text-gray-400">$4120.00</p>
                    </div>

                    <div className="grid grid-cols-4 gap-x-3">
                      <h6 className="col-span-2 font-semibold text-default-600">VAT (12.5):</h6>
            ...
            <div className="mt-10">
              <div className="flex sm:justify-end gap-2 items-center print:hidden">
                <button onClick={() => window.print()} type="submit" className="flex items-center justify-center gap-2 rounded-lg bg-primary px-6 py-2.5 text-center text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-primary-500">
                  <LuPrinter size={20} />
                  Print
                </button>

                <button type="submit" className="rounded-lg bg-primary px-6 py-2.5 text-center text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-primary-500">
                  Submit
                </button>
              </div>
            </div>
