      ...
      <div className="page-content space-y-6 p-6">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="text-center max-w-xl">
            ...
            <Link to="/" className="items-center rounded-lg py-2 px-5 inline-flex font-semibold tracking-wide align-middle duration-500 text-sm text-center bg-primary hover:bg-primary-600 text-white mt-10">
