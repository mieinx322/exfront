...
const Popovers = () => {
  return <div className="grid lg:grid-cols-2 gap-6">
      <div className="rounded-lg border border-default-200">
        <div className="p-6">
          <h4 className="font-medium text-base text-default-600 mb-4">Popovers</h4>
          ...
          <div className="flex flex-wrap gap-3">
            <div className="hs-tooltip inline-block [--trigger:click] [--placement:top]">
              <Link className="hs-tooltip-toggle block text-center" to="">
                ...
                <div className="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible transition-opacity opacity-0 relative hidden px-3 py-1 rounded border bg-white w-60 z-50 dark:bg-gray-600 dark:border-gray-600 dark:text-gray-400" role="tooltip">
          ...
          <div className="flex flex-wrap gap-3">
            <div className="hs-tooltip inline-block [--trigger:hover] [--placement:top]">
              <Link className="hs-tooltip-toggle block text-center" to="">
                ...
                <div className="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible transition-opacity opacity-0 relative hidden px-3 py-1 rounded bg-black text-white z-50" role="tooltip">
                  Top popover
