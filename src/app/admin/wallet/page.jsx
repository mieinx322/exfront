        ...
        <div className="grid gap-6 xl:grid-cols-4">
          <div className="xl:col-span-3">
            ...
            <div className="grid grid-cols-1">
              <TransactionDataTable title="Transaction history" rows={transactionHistoryData} columns={columns} />
            </div>
          </div>
          <div className="xl:col-span-1">
                    ...
                    <span className="flex w-full flex-wrap items-center justify-start gap-4">
                      <span className="shrink">
                        <span className="inline-flex h-12 w-12 overflow-hidden rounded-full">
                          <img src={avatar3Img} className="h-full max-w-full rounded-full" alt="avatar" />
                        </span>
                      </span>
                ...
                <div className="mb-6 rounded-lg border border-default-100 bg-white shadow dark:bg-default-100">
                  <div className="p-4">
                    ...
                    <div className="mb-6 flex flex-wrap items-center gap-2 2xl:flex-nowrap">
                      <div className="flex cursor-pointer flex-col items-center gap-1">
                        <div className="h-12 w-12">
                          <img src={avatar3Img} className="rounded-full" alt="avatar" />
                        </div>
                        <p className="text-xs font-medium text-default-700">Hanna</p>
                      </div>
                      <div className="flex cursor-pointer flex-col items-center gap-1">
                        <div className="h-12 w-12">
                          <img src={avatar4Img} className="rounded-full" alt="avatar" />
                        </div>
                        <p className="text-xs font-medium text-default-700">Alena</p>
                      </div>
                      <div className="flex cursor-pointer flex-col items-center gap-1">
                        <div className="h-12 w-12">
                          <img src={avatar6Img} className="rounded-full" alt="avatar" />
                        </div>
                        <p className="text-xs font-medium text-default-700">Angel</p>
                      </div>
                      <div className="flex cursor-pointer flex-col items-center gap-1">
                        <div className="h-12 w-12">
                          <img src={avatar5Img} className="rounded-full" alt="avatar" />
                        </div>
                        <p className="text-xs font-medium text-default-700">Jhon</p>
                      </div>
                      <div className="flex cursor-pointer flex-col items-center gap-1">
                        <div className="h-12 w-12">
                          <img src={avatar1Img} className="rounded-full" alt="avatar" />
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="grow">
                        <input type="text" className="block w-full rounded-lg border-default-200 bg-transparent px-4 py-2.5 text-sm focus:border-orange-500 focus:ring-0" placeholder={'0'} />
                      </div>
