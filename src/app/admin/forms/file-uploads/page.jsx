      ...
      <div className="page-content space-y-6 p-6">
        ...
        <div className="border border-default-200 rounded-lg">
          <div className="p-6">
            ...
            <div className="pt-5">
              <FilePond className="h-60" labelIdle='<div class="lg:mt-44 md:mt-36 mt-9">Upload Image</div>' imagePreviewHeight={250} imageCropAspectRatio="1:1" styleButtonRemoveItemPosition="center bottom" />
            </div>
          </div>
        </div>
      </div>
