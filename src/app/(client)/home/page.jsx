...
import { circleLineHomeImg, arrowHomeImg, avatar1Img, avatar2Img, avatar3Img, burger1IconCategoryImg, heroHomeImg, aboutUsHomeImg, cupIconImg, vegetablesIconImg, truckIconImg, testimonialHomeImg, avatar4Img, offerPopupHomeImg, mockupHomeImg, offerBgHomeImg } from '@/assets/data/images';
...
const Home = () => {
  return <>
                ...
                <div className="text-center lg:text-start">
                  ...
                  <div className="mb-5 text-3xl font-bold capitalize text-default-950 md:text-5xl/snug lg:text-6xl/normal">
                    ...
                    <span className="relative inline-flex">
                      <span>Delicious</span>
                      <img src={circleLineHomeImg} width={282} height={90} alt="circle" className="absolute -z-10 hidden h-full w-full lg:flex" />
                    </span>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 lg:justify-start">
                      <div className="flex items-center -space-x-1">
                        <div className="h-12 w-12">
                          <img src={avatar1Img} alt="avatar" height={48} width={48} className="h-full w-full rounded-full object-cover object-center ring ring-default-50" />
                        </div>
                        <div className="h-12 w-12">
                          <img src={avatar2Img} alt="avatar" height={48} width={48} className="h-full w-full rounded-full object-cover object-center ring ring-default-50" />
                        </div>
                        <div className="h-12 w-12">
                          <img src={avatar3Img} alt="avatar" height={48} width={48} className="h-full w-full rounded-full object-cover object-center ring ring-default-50" />
                        </div>
                      </div>
                      <div>
              ...
              <div className="absolute bottom-0 start-0">
                <div className="flex items-center gap-2 rounded-full bg-default-50 p-2 pe-6 shadow-lg">
                  <span className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-primary/20">
                    <img src={burger1IconCategoryImg} alt="burger" className="h-10 w-10 rounded-full" />
                  </span>
                  <div>
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2">
            <div>
              <div className="flex h-full w-full items-center justify-center rounded-lg bg-default-500/5">
                <img src={aboutUsHomeImg} alt="about-us-pizza" className="h-full w-full object-cover" />
              </div>
            </div>
            <div>
              ...
              <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
                <div className="rounded-md border border-default-100 bg-transparent shadow-lg transition-all duration-200 hover:border-primary">
                  <div className="p-6">
                    <div className="mb-6">
                      <img src={cupIconImg} width={48} height={48} alt="service-img" />
                    </div>
                ...
                <div className="rounded-md border border-default-100 bg-transparent shadow-lg transition-all duration-200 hover:border-primary">
                  <div className="p-6">
                    <div className="mb-6">
                      <img src={vegetablesIconImg} width={48} height={48} alt="service-img" />
                    </div>
                ...
                <div className="rounded-md border border-default-100 bg-transparent shadow-lg transition-all duration-200 hover:border-primary">
                  <div className="p-6">
                    <div className="mb-6">
                      <img src={truckIconImg} width={48} height={48} alt="service-img" />
                    </div>
          ...
          <div className="grid grid-cols-1 items-center gap-20 lg:grid-cols-2">
            <div>
              <div className="relative">
                <img src={testimonialHomeImg} className="mx-auto lg:mx-0" alt="testimonial" />
                  ...
                  <div className="rounded-xl bg-white shadow-lg dark:bg-default-100">
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-center -space-x-1">
                        <div className="h-12 w-12">
                          <img src={avatar1Img} className="h-full w-full rounded-full object-cover object-center ring ring-default-100" alt="avatar" />
                        </div>
                        <div className="h-12 w-12">
                          <img src={avatar2Img} className="h-full w-full rounded-full object-cover object-center ring ring-default-100" alt="avatar" />
                        </div>
                        <div className="h-12 w-12">
                          <img src={avatar3Img} className="h-full w-full rounded-full object-cover object-center ring ring-default-100" alt="avatar" />
                        </div>
      ...
      <section style={{
      backgroundImage: `url(${offerBgHomeImg})`
        ...
        <div className="container">
          <div className="relative w-full lg:w-1/2">
            ...
            <div className="absolute bottom-10 end-0 lg:-bottom-16">
              <img src={offerPopupHomeImg} className="w-20 lg:w-auto" alt="offer" />
            </div>
          </div>
        </div>
      </section>
