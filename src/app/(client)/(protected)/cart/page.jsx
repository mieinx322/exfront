              ...
              <div className="rounded-lg border border-default-200">
                ...
                <div className="border-t border-default-200 px-6 py-5">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <Link to="/dishes" className="inline-flex items-center justify-center rounded-lg border border-primary px-5 py-3 text-center text-sm font-medium text-primary shadow-sm transition-all duration-500 hover:bg-primary hover:text-white">
                      Shop More
                    </Link>
                  </div>
                </div>
