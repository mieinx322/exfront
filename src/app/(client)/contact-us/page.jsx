          ...
          <div className="grid gap-10 lg:grid-cols-5">
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center justify-center">
                <img src={contactOtherImg} className="h-full max-w-full" alt="contact" />
              </div>
            </div>
        ...
        <div className="container">
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="rounded-lg bg-default-400/10">
              <div className="p-8">
                <Link to="tel:+7867862387444" className="mb-6 flex items-center gap-4">
                ...
                <Link to="tel:+1234XXXX123" className="mb-2 text-sm text-default-500 block">
                  +1 234 XXXX 123
                </Link>
                <Link to="tel:+1234XXXX567" className="text-sm text-default-500 block">
                  +1 234 XXXX 567
                </Link>
              </div>
            </div>
            <div className="rounded-lg bg-default-400/10">
              <div className="p-8">
                <Link to="mailto:demomail123@mail.com" className="mb-6 flex items-center gap-4">
                ...
                <Link to="mailto:support@coderthemes.com" className="mb-2 text-sm text-default-500 block">
                  support@coderthemes.com
                </Link>
                <Link to="mailto:helpdemo123@mail.com" className="text-sm text-default-500 block">
