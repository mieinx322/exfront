...
const RegisterForm = () => {
  ...
  return <form onSubmit={handleSubmit(() => null)}>
      <TextFormInput name="fullName" control={control} type="text" className='bg-white' placeholder="Enter your name" containerClassName="mb-6" label="Full Name" fullWidth />

      <TextFormInput name="email" control={control} type="email" placeholder="Enter your email" className='bg-white' containerClassName="mb-6" label="Email" fullWidth />
